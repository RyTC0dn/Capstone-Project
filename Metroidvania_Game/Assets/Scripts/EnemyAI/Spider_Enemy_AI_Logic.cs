...
public class Spider_Enemy_AI_Logic : MonoBehaviour
{
    [Header("References")]
    ...
    private float h;
    private SpiderStates currentState;
    ...
    public void StateSwitch(SpiderStates state)
    {
    ...
    private void FixedUpdate()
    {
        ...
        switch (currentState)
        {
            case SpiderStates.Patrol:
                Patrolling();

                if(playerInView)
                    StateSwitch(SpiderStates.Chase);
                break;
            case SpiderStates.Chase:
                Chase();
